...
public class Game {
    ...
    private int playRound(Player maximizer, Player minimizer) throws InvalidMoveException, TimeOutException {
        ...
        while (turn < g.getN()) {
            ...
            // HashMap<Vertex, Coordinate> copyOfVertexCoordinates =
            // copyVertexCoordinates(vertexCoordinates);
            ...
            // usedCoordinates[newMove.getCoordinate().getX()][newMove.getCoordinate().getY()]
            // = 1;
